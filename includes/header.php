    ...
    <nav class="glass-nav fixed w-full z-50 top-0 left-0 shadow-sm">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center relative">
            ...
            <div class="hidden md:flex items-center space-x-8">
               ...
               <a href="../pages/timetable.php" class="text-gray-700 hover:text-indigo-600 font-medium transition nav-link">Timetable</a>
                <a href="../pages/about.php" class="text-gray-700 hover:text-indigo-600 font-medium transition nav-link">About</a>
                <a href="../pages/teachers.php" class="text-gray-700 hover:text-indigo-600 font-medium transition nav-link">Teachers</a>
