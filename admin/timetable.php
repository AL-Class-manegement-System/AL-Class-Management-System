    ...
    <div class="ml-64 flex flex-col min-h-screen">
        ...
        <header class="bg-white shadow-sm py-4 px-8 flex justify-between items-center sticky top-0 z-40">
            ...
            <a href="add_timetable.php"
                class="bg-indigo-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-indigo-700 transition shadow-lg flex items-center gap-2">
        ...
        <main class="p-8">
            ...
            <?php if (isset($_GET['msg'])): ?>
                <div
                    ...
                    <button onclick="this.parentElement.style.display='none'" class="text-green-700"><i
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase">Class Name
                                </th>
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase">Subject &
                                    Stream</th>
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase">Teacher</th>
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase">Date & Time
                                </th>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-bold text-gray-800">
                                                <?php echo htmlspecialchars($row['class_name']); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900 font-semibold">
                                                <?php echo htmlspecialchars($row['subject']); ?></div>
                                            <div
                                                class="text-xs text-indigo-500 bg-indigo-50 px-2 py-0.5 rounded inline-block mt-1">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-700">
                                                <i
                                                    class="fas fa-user-tie text-gray-400 mr-2"></i><?php echo htmlspecialchars($row['teacher_name']); ?>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                            ...
                                            <div class="text-xs text-gray-500 mt-1 pl-1"><i
                                                    class="far fa-clock mr-1"></i><?php echo htmlspecialchars($row['time']); ?>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex gap-3">
                                            <a href="edit_timetable.php?id=<?php echo $row['class_id']; ?>"
