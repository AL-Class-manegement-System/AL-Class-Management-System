...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-slate-900 border-r border-slate-800 sm:translate-x-0 flex flex-col font-sans" aria-label="Sidebar">
   ...
   <div class="flex-1 px-3 py-4 overflow-y-auto custom-scrollbar">
      <ul class="space-y-1 font-medium">
         ...
         <li>
            <a href="dashboard.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('dashboard.php'); ?>">
         ...
         <li>
            <a href="student.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('student.php'); ?>">
         ...
         <li>
            <a href="teachers.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('teachers.php'); ?>">
         ...
         <li>
            <a href="timetable.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('timetable.php'); ?>">
         ...
         <li>
            <a href="approve_exams.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('approve_exams.php'); ?>">
         ...
         <li>
            <a href="manage_study_materials.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('manage_study_materials.php'); ?>">
         ...
         <li>
            <a href="manage_live_class.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('manage_live_class.php'); ?>">
         ...
         <li>
            <a href="mark_attendance.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('mark_attendance.php'); ?>">
         ...
         <li>
            <a href="payments.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('payments.php'); ?>">
         ...
         <li>
            <a href="accounting.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('accounting.php'); ?>">
         ...
         <li>
            <a href="manage_notices.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('manage_notices.php'); ?>">
         ...
         <li>
            <a href="settings.php" class="flex items-center p-2 rounded-lg transition-all duration-200 group <?php echo getAdminActive('settings.php'); ?>">
   ...
   <div class="p-3 border-t border-slate-800 bg-slate-950">
      <a href="logout.php" class="flex items-center p-2 text-red-400 rounded-lg hover:bg-red-500/10 hover:text-red-300 transition-all duration-200 group">
