            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (!empty($img) && file_exists("../assets/images/teachers/" . $img)) {
                        ...
                        $imagePath = "https://ui-avatars.com/api/?name=" . urlencode($row['full_name']) . "&background=random&size=500"; // size=500 එකතු කළා
                    }
            ?>
            ...
            <div class="group relative bg-white rounded-3xl shadow-sm hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300">
                ...
                <div class="relative h-72 overflow-hidden">
                    <img src="<?php echo $imagePath; ?>" 
                         ...
                         style="image-rendering: -webkit-optimize-contrast; image-rendering: crispedges;">
                    
                    <div class="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-indigo-700 shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <div class="pt-4 border-t border-gray-100 flex justify-between items-center">
                        ...
                        <a href="#" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium transition-colors">View Profile →</a>
                    </div>
                </div>
            </div>
            <?php 
