    ...
    <div class="ml-64 flex flex-col min-h-screen">
        ...
        <main class="p-8">
            ...
            <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6 rounded shadow-sm flex justify-between items-center">
                <div><p class="font-bold">Success</p><p class="text-sm"><?php echo htmlspecialchars($_GET['msg']); ?></p></div>
            ...
            <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6 rounded shadow-sm">
                <p class="font-bold">Error</p><p class="text-sm"><?php echo htmlspecialchars($_GET['error']); ?></p>
            </div>
            <?php endif; ?>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    $teachers_by_subject[$row['subject']][] = $row;
                }
            }
            ...
            ?>
                ...
                <div class="mb-10">
                    ...
                    <div class="flex items-center gap-3 mb-6 border-b border-gray-200 pb-2">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800"><?php echo htmlspecialchars($subject); ?> Teachers</h2>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition group">
                            ...
                            <div class="p-5">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded uppercase tracking-wide">
                                        <?php echo isset($row['teacher_number']) ? htmlspecialchars($row['teacher_number']) : 'NO ID'; ?>
                                    </span>
                                </div>
                                ...
                                <div class="flex gap-2 pt-3 border-t border-gray-100">
                                    <a href="edit_teacher.php?id=<?php echo $row['teacher_id']; ?>" 
                                       class="flex-1 bg-indigo-50 text-indigo-600 py-2 rounded-lg text-sm font-medium hover:bg-indigo-100 transition text-center group-hover:bg-indigo-600 group-hover:text-white">
                                    ...
                                    <a href="delete_teacher.php?id=<?php echo $row['teacher_id']; ?>" 
                                       ...
                                       class="flex-1 bg-red-50 text-red-600 py-2 rounded-lg text-sm font-medium hover:bg-red-100 transition text-center group-hover:bg-red-600 group-hover:text-white">
            ...
            ?>
                <div class="col-span-full flex flex-col items-center justify-center py-20 text-gray-400 bg-white rounded-xl border border-dashed border-gray-300">
                    <i class="fas fa-chalkboard-teacher text-5xl mb-4 text-indigo-200"></i>
                    <p class="text-lg font-medium text-gray-500">No teachers added yet.</p>
                    <a href="add_teacher.php" class="mt-4 text-indigo-600 hover:underline text-sm">Add your first teacher</a>
                </div>
            <?php } ?>
