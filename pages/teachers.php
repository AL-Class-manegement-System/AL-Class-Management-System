...
<div class="min-h-screen bg-gray-50/50 pb-20">
    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <?php
            // Active teachers la witharak gannawa
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div
                        class="group relative bg-white rounded-3xl shadow-sm hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300">

                        <div class="relative h-72 overflow-hidden">
                            <img src="<?php echo $imagePath; ?>" alt="<?php echo htmlspecialchars($row['full_name']); ?>"
                                class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">

                            <div
                                class="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-indigo-700">
                        ...
                        <div class="p-6">
                            ...
                            <div class="pt-4 border-t border-gray-100 flex justify-between items-center">
                                ...
                                <a href="teacher-profile.php?id=<?php echo $row['teacher_id']; ?>"
                                    class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">View Profile →</a>
                            </div>
                        </div>
                    </div>
                    <?php
