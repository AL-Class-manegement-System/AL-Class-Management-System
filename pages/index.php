    ...
    <div class="flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        <div class="w-full lg:w-1/2 text-center lg:text-left z-10">
            ...
            <p class="text-lg text-gray-600 mb-8 hero-desc opacity-0">
                Master Physics, Chemistry, Maths & Biology with the island's best lecturers. Comprehensive Theory,
            ...
            <div
                class="mt-12 flex justify-center lg:justify-start gap-8 border-t border-gray-200 pt-8 hero-stats opacity-0">
                <div>
        ...
        <div class="w-full lg:w-1/2 relative hero-img-container opacity-0">
            <div class="relative z-10 w-full max-w-md mx-auto">
                <div
                    class="aspect-square bg-gradient-to-br from-indigo-100 to-white rounded-3xl shadow-2xl flex items-center justify-center border border-white/50 relative overflow-hidden">
                    ...
                    <div class="relative z-10 text-center">
                        <div
                            class="w-24 h-24 bg-white rounded-2xl shadow-xl flex items-center justify-center mx-auto mb-4 text-indigo-600 text-4xl animate-bounce">
                    ...
                    <div
                        class="absolute top-10 left-4 bg-white p-3 rounded-xl shadow-lg flex items-center gap-3 animate-pulse">
                        <div
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="glass-card p-8 rounded-2xl text-center feature-card opacity-0 translate-y-10">
                <div
                    class="w-16 h-16 mx-auto bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-2xl mb-6">
                    <i class="fas fa-book-reader"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-800 mb-3">Theory & Revision</h3>
                <p class="text-gray-600">Complete syllabus coverage with special revision sessions targeting difficult
                    areas.</p>
            </div>

            <div class="glass-card p-8 rounded-2xl text-center feature-card opacity-0 translate-y-10">
                <div
                    class="w-16 h-16 mx-auto bg-pink-100 text-pink-600 rounded-full flex items-center justify-center text-2xl mb-6">
                    <i class="fas fa-file-alt"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-800 mb-3">Model Papers</h3>
                <p class="text-gray-600">Regular unit tests and island-wide mock exams to prepare you for the real
                    challenge.</p>
            </div>

            <div class="glass-card p-8 rounded-2xl text-center feature-card opacity-0 translate-y-10">
                <div
                    class="w-16 h-16 mx-auto bg-cyan-100 text-cyan-600 rounded-full flex items-center justify-center text-2xl mb-6">
                    <i class="fas fa-chart-line"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-800 mb-3">Progress Tracking</h3>
                <p class="text-gray-600">Individual attention and performance tracking to improve your Z-Score
                    systematically.</p>
            </div>
        </div>
    </div>
