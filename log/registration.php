...
<body class="antialiased text-gray-300 py-6 px-4">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-700 relative">
            ...
            <div
                class="bg-gradient-to-r from-indigo-900 to-blue-900 p-6 text-center relative overflow-hidden border-b border-gray-700">
                <div
                    class="absolute top-0 right-0 -mr-8 -mt-8 w-24 h-24 rounded-full bg-white opacity-5 blur-xl pointer-events-none">
                </div>
                <div
                    class="absolute bottom-0 left-0 -ml-8 -mb-8 w-24 h-24 rounded-full bg-white opacity-5 blur-xl pointer-events-none">
                </div>

                <div class="relative z-10 flex items-center justify-center gap-3">
                    <div
                        class="w-10 h-10 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg">
                ...
                <form id="studentForm" action="../lib/registrationbackend.php" method="POST"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-400 mb-1 required">NIC
                                    Number</label>
                                <div class="relative group">
                                    <div
                                        class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-400 mb-1 required">Date of
                                    Birth</label>
                                <div class="relative group">
                                    <div
                                        class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">
                                    ...
                                    <input type="date" id="dob" name="date_of_birth"
                                        class="w-full pl-9 pr-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm text-white focus:bg-gray-600 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all outline-none"
                                        required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div
                                    class="flex items-center space-x-4 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 h-[38px]">
                                    <label
                                        class="flex items-center cursor-pointer hover:text-indigo-400 transition-colors">
                                        <input type="radio" name="gender" value="Male"
                                            class="w-3.5 h-3.5 text-indigo-500 border-gray-500 focus:ring-indigo-500 bg-gray-600"
                                            required>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative group">
                                    <div
                                        class="absolute top-2.5 left-3 flex items-center pointer-events-none text-gray-500">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-400 mb-1 required">Parent
                                    Phone</label>
                                <div class="relative group">
                                    <div
                                        class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-xs font-semibold text-gray-400 mb-1 required">Email
                                    Address</label>
                                <div class="relative group">
                                    <div
                                        class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-indigo-400">
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <select id="stream" name="stream"
                                        class="w-full pl-9 pr-8 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm text-white focus:bg-gray-600 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 appearance-none outline-none cursor-pointer"
                                        required>
                                        <option value="" selected disabled class="bg-gray-800 text-gray-400">Select
                                        </option>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <select id="batch" name="batch"
                                        class="w-full pl-9 pr-8 py-2 bg-gray-700 border border-gray-600 rounded-lg text-sm text-white focus:bg-gray-600 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 appearance-none outline-none cursor-pointer"
                                        required>
                                        <option value="" selected disabled class="bg-gray-800 text-gray-400">Year
                                        </option>
                    ...
                    <div class="mb-6">
                        ...
                        <div
                            class="flex items-center gap-6 bg-gray-700/30 p-4 rounded-xl border border-dashed border-gray-600">
                            <div class="w-16 h-16 rounded-full border-2 border-gray-500 shadow-lg overflow-hidden bg-gray-600 flex-shrink-0"
                                id="photoPreview">
                            ...
                            <div class="flex-1">
                                <label for="photo"
                                    class="cursor-pointer text-sm bg-gray-600 border border-gray-500 text-gray-200 font-medium py-1.5 px-3 rounded shadow-sm hover:bg-gray-500 hover:text-white transition-all inline-flex items-center gap-2">
                    ...
                    <div class="flex gap-3 pt-4 border-t border-gray-700 mt-2">
                        ...
                        <a href="login.php"
                            class="w-1/3 flex items-center justify-center gap-2 py-3 bg-transparent border border-gray-600 text-gray-300 text-sm font-bold rounded-xl hover:bg-gray-700 hover:text-white hover:border-gray-500 transition-all shadow-sm">
                            <i class="fa-solid fa-arrow-left"></i>
                            Back
                        </a>

                        <button type="submit"
                            class="w-2/3 flex items-center justify-center gap-2 py-3 text-white bg-indigo-600 hover:bg-indigo-500 text-sm font-bold rounded-xl shadow-lg shadow-indigo-900/50 transition-all transform hover:-translate-y-0.5">
        ...
        <p class="text-center text-gray-500 text-xs mt-6">&copy; <?php echo date('Y'); ?> Education Management System
        </p>
    </div>
