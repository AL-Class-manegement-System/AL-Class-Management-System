            ...
            <div class="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden mb-8">
                ...
                <div class="px-8 pb-8 relative">
                    <div class="relative -mt-16 mb-4 flex justify-between items-end">
                        ...
                        <button
                            class="bg-indigo-50 text-indigo-600 px-4 py-2 rounded-lg font-semibold text-sm hover:bg-indigo-100 transition">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-slate-800">
                            <?php echo htmlspecialchars($student['full_name']); ?></h1>
                        <p class="text-slate-500 font-medium flex items-center gap-2 mt-1">
                            ...
                            <span
                                class="px-2 py-0.5 bg-blue-100 text-blue-600 text-xs rounded-full font-bold uppercase"><?php echo htmlspecialchars($student['stream']); ?>
                                Stream</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-slate-700 font-medium"><?php echo htmlspecialchars($student['full_name']); ?>
                            </p>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Date of Birth
                                </p>
                                <p class="text-slate-700 font-medium"><?php echo htmlspecialchars($student['dob']); ?>
                                </p>
                            </div>
                            <div>
                                ...
                                <p class="text-slate-700 font-medium capitalize">
                                    <?php echo htmlspecialchars($student['gender']); ?></p>
                            </div>
                        </div>
                        <div>
                            <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">NIC Number</p>
                            <p class="text-slate-700 font-medium"><?php echo htmlspecialchars($student['nic']); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Address</p>
                            <p class="text-slate-700 font-medium"><?php echo htmlspecialchars($student['address']); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-slate-700 font-medium">
                                    <?php echo htmlspecialchars($student['school']); ?></p>
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Batch / Year
                                    </p>
                                    <p class="text-slate-700 font-medium">
                                        <?php echo htmlspecialchars($student['batch']); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Status</p>
                                    <span
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Email Address
                                </p>
                                <p class="text-slate-700 font-medium"><?php echo htmlspecialchars($student['email']); ?>
                                </p>
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Student
                                        Phone</p>
                                    <p class="text-slate-700 font-medium">
                                        <?php echo htmlspecialchars($student['student_phone']); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-400 uppercase tracking-wide font-semibold">Parent Phone
                                    </p>
                                    <p class="text-slate-700 font-medium">
                                        <?php echo htmlspecialchars($student['parent_phone']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
