    ...
    <div class="flex h-screen overflow-hidden relative">
        ...
        <aside id="sidebar" 
            ...
            <div class="h-20 flex items-center justify-between px-6 border-b border-slate-700 bg-slate-950">
                ...
                <button onclick="toggleSidebar()" class="md:hidden text-slate-400 hover:text-white focus:outline-none transition-colors p-2">
                    <i class="fas fa-times text-xl"></i>
                </button>
            </div>

            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                <a href="#" class="flex items-center px-4 py-3 bg-primary text-white rounded-xl transition-all shadow-lg shadow-indigo-500/30 group">
                    <i class="fas fa-th-large w-6 text-center"></i>
                    <span class="ms-3 font-medium">Dashboard</span>
                </a>

                <a href="#" class="flex items-center px-4 py-3 text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl transition-all group">
            ...
            <div class="p-4 border-t border-slate-800 bg-slate-950">
                <a href="../../lib/logout.php" class="flex items-center px-4 py-3 text-red-400 hover:bg-red-500/10 rounded-xl transition-all group">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-y-auto w-full relative">
            ...
            <header class="mx-4 mt-4 mb-6 rounded-2xl h-20 bg-white shadow-sm flex items-center justify-between px-6 sticky top-4 z-10 border border-gray-100">
                
                <div class="flex items-center gap-4">
                    <button onclick="toggleSidebar()" class="md:hidden text-slate-500 hover:text-primary focus:outline-none p-2 -ml-2 rounded-lg hover:bg-slate-50 transition-colors">
                ...
                <div class="flex items-center gap-4 md:gap-6">
                    <button class="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-500 hover:text-primary transition relative border border-slate-200 hover:border-primary/30">
                    ...
                    <div class="flex items-center gap-3 pl-4 border-l border-gray-100">
                        ...
                        <div class="relative">
                            <button onclick="toggleDropdown()" class="flex items-center focus:outline-none ring-2 ring-transparent hover:ring-primary/20 rounded-full transition-all">
                                <img src="<?php echo isset($profile_pic) ? $profile_pic : '../../assets/images/user2.jpg'; ?>" 
                                     class="w-10 h-10 rounded-full object-cover border-2 border-white shadow-sm"
                                     alt="Profile">
                            </button>

                            <div id="userDropdown" class="hidden absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl py-2 z-50 ring-1 ring-black ring-opacity-5 transition-all duration-200 ease-out origin-top-right transform animate-fade-in-down border border-gray-100">
                                ...
                                <a href="../../lib/logout.php" class="flex items-center px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors rounded-b-xl">
